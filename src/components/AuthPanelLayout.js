...
function AuthPanelLayout({ children }) {
  return (
    <div className="flex justify-start items-start h-[100vh] relative sm:flex-col sm:flex-wrap">
      <div className=" bg-darkblue md:h-[100vh] hidden md:block md:w-[50%] sm:w-[100%]">
        <div className="pt-[60px] px-[60px]">
          <h2 className="text-white">
            Your authentic career platform that helps you find your true purpose.
          </h2>
        </div>
        <img src={HeroVector} alt="Login" className="w-[80%]" />
      </div>

      <div className="flex flex-col items-center md:h-[100vh] md:w-[50%] sm:w-[100%] bg-gradient-to-b from-gradientfrom to-gradientto">
        <div className="pt-[60px] px-[60px]">
