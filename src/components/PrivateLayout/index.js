...
const PrivateLayout = ({ children }) => {
  return (
    <div>
      <div
        className="flex w-full flex-col bg-fixed bg-bottom bg-cover"
      ...
      >
        ...
        <div className="px-0 md:px-[5%] mt-[61px] flex-grow grid grid-cols-12 gap-5 ">
          ...
          <div className="col-span-12 md:col-span-8 min-h-[calc(100vh-61px)] overflow-y-auto lg:col-span-6 md:py-[14px] mb-[60px] md:mb-0">
            {children}
